// Server-side companion to assets/js/countries.js (same ISO 3166-1 list, German
// names) — kept as a separate small CommonJS module since the client-side file
// is a plain browser script, not something Node can require() directly.
const COUNTRIES_RAW = [
